...
void writeTime(uint8_t dig1, uint8_t dig2, uint8_t dig3, uint8_t dig4)
{
  ...
  // display MinOne
  for (y = 5; y > 1; y--) {
    LEDMAT[i] = LETTERS[dig4 + DIGIT_OFFSET][y - 2];
    i = i - 1;
  }
  ...
  if (dig3 == 1) {                                            
    ...
    for (y = 5; y > 1; y--) {
      LEDMAT[i] = LETTERS[dig3 + DIGIT_OFFSET][y - 2];
      i = i - 1;
    }
  }
  ...
  if (dig2 == 1 || dig1 == 3) {
    LEDMAT[i] = 0;
    LEDMAT[i - 1] = (showColon == true ? 20 : 0);
    LEDMAT[i - 2] = 0;
    i = i - 3;
  } else {
    LEDMAT[i] = (showColon == true ? 20 : 0);(showColon == true ? 20 : 0);
    LEDMAT[i - 1] = 0;
    i = i - 2;
  }
  ...
  if (dig2 == 1) {
    ...
    for (y = 5; y > 1; y--) {
      LEDMAT[i] = LETTERS[dig2 + DIGIT_OFFSET][y - 2];
      i = i - 1;
    }
  }
  ...
  if (dig1 == 1) {
    ...
    for (y = 5; y > 1; y--) {
      LEDMAT[i] = LETTERS[dig1 + DIGIT_OFFSET][y - 2];
      i = i - 1;
    }
  }
